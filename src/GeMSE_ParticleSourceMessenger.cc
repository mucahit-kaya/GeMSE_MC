...
GeMSE_ParticleSourceMessenger::GeMSE_ParticleSourceMessenger(
  ...
  m_pListCmd = new G4UIcmdWithoutParameter("/GeMSE/gun/List", this);
  m_pListCmd->SetGuidance("List available particles.");
  m_pListCmd->SetGuidance(" Invoke G4ParticleTable.");

  // set particle
  m_pParticleCmd = new G4UIcmdWithAString("/GeMSE/gun/particle", this);
  ...
  // particle direction
  m_pDirectionCmd = new G4UIcmdWith3Vector("/GeMSE/gun/direction", this);
  ...
  // particle energy
  m_pEnergyCmd = new G4UIcmdWithADoubleAndUnit("/GeMSE/gun/energy", this);
  m_pEnergyCmd->SetGuidance("Set kinetic energy.");
  m_pEnergyCmd->SetParameterName("Energy", true, true);
  m_pEnergyCmd->SetDefaultUnit("GeV");

  m_pPositionCmd = new G4UIcmdWith3VectorAndUnit("/GeMSE/gun/position", this);
  ...
  // ion
  m_pIonCmd = new G4UIcommand("/GeMSE/gun/ion", this);
  ...
  // source shape
  m_pShapeCmd = new G4UIcmdWithAString("/GeMSE/gun/shape", this);
  ...
  // center coordinates
  m_pCenterCmd = new G4UIcmdWith3VectorAndUnit("/GeMSE/gun/center", this);
  ...
  m_pHalfxCmd = new G4UIcmdWithADoubleAndUnit("/GeMSE/gun/halfx", this);
  ...
  m_pHalfyCmd = new G4UIcmdWithADoubleAndUnit("/GeMSE/gun/halfy", this);
  ...
  m_pHalfzCmd = new G4UIcmdWithADoubleAndUnit("/GeMSE/gun/halfz", this);
  ...
  // radius of source
  m_pRadiusCmd = new G4UIcmdWithADoubleAndUnit("/GeMSE/gun/radius", this);
  ...
  // confine to volume(s)
  m_pConfineCmd = new G4UIcmdWithAString("/GeMSE/gun/confine", this);
  ...
  m_pAngTypeCmd = new G4UIcmdWithAString("/GeMSE/gun/angtype", this);
  ...
  // energy distribution
  m_pEnergyTypeCmd = new G4UIcmdWithAString("/GeMSE/gun/energytype", this);
  ...
  m_pEnergyFileCmd = new G4UIcmdWithAString("/GeMSE/gun/energyspectrum", this);
  m_pEnergyFileCmd->SetGuidance("File containing energy spectrum");
  m_pEnergyFileCmd->SetParameterName("EnergySpectrum", false);

  // verbosity
  m_pVerbosityCmd = new G4UIcmdWithAnInteger("/GeMSE/gun/verbose", this);
...
void GeMSE_ParticleSourceMessenger::SetNewValue(G4UIcommand *command,
  ...
  if (command == m_pGeneratorCmd)
  {
    ...
    m_pParticleSource->SetCenterCoords(
    ...
    if (m_bShootIon) {
      ...
      G4cout << "Set /GeMSE/gun/particle to ion before using /GeMSE/gun/ion "
                "command";
      G4cout << G4endl;
    }
  }
